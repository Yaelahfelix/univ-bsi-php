...
<head>
    ...
    <style>
        ...
        * {
        ...
        /* ---------- NAVBAR (New) ---------- */
        /* Structure:
           - sticky top bar with subtle backdrop
           - left: brand/logo
           - center: main links
           - right: actions (cta + hamburger on mobile)
        ...
        /* Mobile: hamburger & collapsed menu */
        .hamburger {
            display:none;
            background:transparent;
            border:0;
        ...
        @media (max-width: 880px) {
            .nav-links { display:none; } /* hide center links on smaller screens */
        ...
        /* FOOTER (Updated styling to be more like bsi.id.ac) */
        footer {
            border-top: 1px solid #e5e7eb;
            padding: 48px 0;
            color: var(--slate-600);
...
<body>
    ...
    <nav class="nav" role="navigation" aria-label="Main Navigation">
        <div class="container nav-inner">
            <!-- Brand -->
            <div class="brand">
                <!-- simple SVG / image logo could be swapped; kept inline for portability -->
                <a href="/" aria-label="Kampus BSI home" style="display:flex;align-items:center;gap:20px">
                    <img src="https://bsi.today/wp-content/uploads/2021/05/logo-bsi.png" alt="BSI logo" />
                    <span>Kampus <span style="color:var(--accent)">BSI</span></span>
                </a>
            </div>

            <!-- Center links (hidden on mobile) -->
            <div class="nav-links" role="menubar" aria-label="Primary">
                <a href="#program" role="menuitem">Program Studi</a>
                <a href="#fasilitas" role="menuitem">Fasilitas</a>
                <a href="#testimoni" role="menuitem">Testimoni</a>
                <a href="#faq" role="menuitem">FAQ</a>
                <a href="#kontak" role="menuitem">Kontak</a>
            </div>

            <!-- Right side actions -->
            <div class="nav-actions">
                <!-- "Masuk" (login) desktop  -->
                <a class="btn-ghost nav-desktop-only" href="login.php">Masuk</a>
                <!-- CTA -->
                <a class="btn-primary" href="pendaftaran.php">Daftar Sekarang</a>

                <!-- Display Mobile -->
                <button class="hamburger" id="nav-toggle" aria-expanded="false" aria-controls="mobile-menu" aria-label="Toggle menu">☰</button>
            </div>
        </div>
        ...
        <div id="mobile-menu" class="mobile-menu" aria-hidden="true">
            ...
            <a href="pendaftaran.php" style="margin-top:8px;font-weight:900">Daftar Sekarang</a>
        </div>
    </nav>
    ...
    <!-- FOOTER -->
    <!-- Footer content kept, but styles updated to match BSI-ish layout: columns, CTA area, socials -->
    <footer id="kontak" aria-labelledby="footer-heading">
        <div class="container">
            <div class="footer-grid">
                <div>
                    <div class="footer-brand">
                        <!-- small mark + name -->
                        <svg width="36" height="36" viewBox="0 0 24 24" fill="none" aria-hidden="true"><rect width="24" height="24" rx="6" fill="#eef2ff"></rect><path d="M6 12h12" stroke="#4f46e5" stroke-width="1.6" stroke-linecap="round"/></svg>
                        <div>
                            <div style="font-weight:900;color:#0f172a">Kampus BSI</div>
                            <div style="font-size:13px;color:var(--slate-600)">Kampus praktis & relevan untuk industri.</div>
                        </div>
                    </div>
                ...
                <div class="footer-contact">
                    ...
                    <ul>
                        <li>Email: <a href="mailto:admisi@kampusbsi.ac.id">admisi@kampusbsi.ac.id</a></li>
                ...
                <div>
                    ...
                    <div style="margin-top:12px">
                        <a class="btn btn--primary" href="pendaftaran.php" style="display:inline-block">Daftar Sekarang</a>
                    </div>
                </div>
            </div>

            <div class="footer-bottom">
                <div>© <?= date('Y') ?> Kampus BSI.</div>
                <div style="color:var(--slate-500)">Terakreditasi oleh BAN-PT / LLDikti - Informasi resmi & transparan.</div>
            </div>
        </div>
    </footer>

    <script>
        // ------- NAVIGASI buat mobile toggle -------
        (function(){
            ...
            // Close menu on resize > breakpoint to avoid stuck open state
